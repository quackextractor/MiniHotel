...
* Czech version of this document: `TECHNICKA-DOKUMENTACE.md`
* System architecture diagram: `diagrams/01-system-architecture.drawio.xml`
* Authentication sequence diagram: `diagrams/03-auth-sequence.drawio.xml`
